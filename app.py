...
NAMES = [
    "AGUILAR GONZALEZ JORGE ANGEL", "BAIRAN INES ASHLY AMARILIZ", "CHAZARI MARTINEZ MANUEL",
    "CRUZ MONGE FELIX MANUEL", "GALLARDO FERNANDEZ JOSS SETI RAMSES", "GOMEZ GARCIA ANGEL",
    "GONZALEZ CABA YAIR", "GONZALEZ ROJAS ANGEL OSVALDO", "GONZALEZ SANDOVAL JUAN CARLOS",
    "LOPEZ SOLARES VICTOR", "OREA SANCHEZ LUIS ENRIQUE", "PEÑA CORONA EDUARDO",
    "RAMIREZ DE LA LLAVE GABRIEL JESUS", "REYES GARCIA LUIS GUSTAVO", "ROMANO FUENTES DANIEL ARTURO",
    "RUIZ LOPEZ LEVI ALBERTO", "SANCHEZ JUAREZ OSCAR", "SOLEDAD CAPILLA DIANA SARAHI",
    "TEPATLAN ROSAS URIEL ENRIQUE", "TORRES MIRASOL JORGE", "VAZQUEZ DE LA CRUZ JAIR",
    "VEGA GOMEZ JONATHAN", "VILLEGAS AMBRIZ ANA BELEN", "ZEMPOALTECATL MARIN MARIA TERESA",
    "ZEPEDA PEREZ EMIR"
]
